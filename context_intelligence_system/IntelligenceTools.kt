package com.saaam.nexus.plugin.mcp.tools

import com.intellij.openapi.project.Project
import com.saaam.nexus.plugin.intelligence.ContextIntelligence
import com.saaam.nexus.plugin.intelligence.RelevanceScore
...
class IntelligenceTools(
    ...
    private fun buildDependencyTree(
        filePath: String,
        context: com.saaam.nexus.plugin.intelligence.ProjectContext,
        maxDepth: Int
    ): String = buildString {
