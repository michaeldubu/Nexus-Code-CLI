...
import { NexusFileSystem, ConversationMessage } from './nexus-fs.js';
...
export class NexusIntelligence {
  ...
  async initialize(): Promise<void> {
    console.log(chalk.cyan('🧠 Initializing Nexus Intelligence...'));
    await this.contextEngine.initialize();
    console.log(chalk.green('✅ Intelligence layer active'));
  }
